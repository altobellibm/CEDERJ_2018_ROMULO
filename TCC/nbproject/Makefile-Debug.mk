...
${OBJECTDIR}/_ext/26289040/mkl.o: /opt/cuda/include/cusplibrary-develop/performance/mkl/mkl.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/26289040/mkl.o /opt/cuda/include/cusplibrary-develop/performance/mkl/mkl.c

${OBJECTDIR}/_ext/61fe2933/mkl.o: /opt/cuda/include/performance/mkl/mkl.c
	${MKDIR} -p ${OBJECTDIR}/_ext/61fe2933
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/61fe2933/mkl.o /opt/cuda/include/performance/mkl/mkl.c

${OBJECTDIR}/_ext/1c8aa706/Template.o: /usr/include/X11/Xaw/Template.c
	${MKDIR} -p ${OBJECTDIR}/_ext/1c8aa706
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1c8aa706/Template.o /usr/include/X11/Xaw/Template.c

${OBJECTDIR}/_ext/bfbadf9e/fftw3.o: /usr/include/fftw3.f
	${MKDIR} -p ${OBJECTDIR}/_ext/bfbadf9e
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/bfbadf9e/fftw3.o /usr/include/fftw3.f

${OBJECTDIR}/_ext/bfbadf9e/fftw3.o: /usr/include/fftw3.f03
	${MKDIR} -p ${OBJECTDIR}/_ext/bfbadf9e
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/bfbadf9e/fftw3.o /usr/include/fftw3.f03

${OBJECTDIR}/_ext/bfbadf9e/fftw3l.o: /usr/include/fftw3l.f03
	${MKDIR} -p ${OBJECTDIR}/_ext/bfbadf9e
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/bfbadf9e/fftw3l.o /usr/include/fftw3l.f03

${OBJECTDIR}/_ext/bfbadf9e/fftw3q.o: /usr/include/fftw3q.f03
	${MKDIR} -p ${OBJECTDIR}/_ext/bfbadf9e
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/bfbadf9e/fftw3q.o /usr/include/fftw3q.f03
...
${OBJECTDIR}/_ext/7bff708d/gobjectnotifyqueue.o: /usr/include/glib-2.0/gobject/gobjectnotifyqueue.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7bff708d/gobjectnotifyqueue.o /usr/include/glib-2.0/gobject/gobjectnotifyqueue.c
